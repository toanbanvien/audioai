<?php
/**
 * Drag Items in the Theme Customizer.
 *
 * @package Prespa
 */

if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Prespa_Sortable_Repeater_Custom_Control' ) ) {
	 ...
	 */
	class Prespa_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
